...
def cost_func(params, circuit, hamiltonian, estimator=None):
...
def gradi(i, params, circuit, hamiltonian, estimator=None):
    delta = np.zeros(len(params))
    delta[i] = math.pi/2
    costp = cost_func(params+delta, circuit, hamiltonian)
    costm = cost_func(params-delta, circuit, hamiltonian)
