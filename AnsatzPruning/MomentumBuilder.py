...
def momen_layer():
    return None
def MomentumBuilder(params:list, ansatz:QuantumCircuit, layers:int, 
                 circuit:QuantumCircuit, hamiltonian:SparsePauliOp, estimator:Estimator, beta1:float, beta2:float):
    ...
    for l in range(0,layers):
        ...
        for i in range(len(params)):
            ...
            grad_i=abs(gradi(i,params,tempCircuit,hamiltonian,estimator)[len(hamiltonian)-1]).item()
